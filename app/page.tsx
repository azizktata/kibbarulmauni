    ...
    <div className="relative min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 text-center">
          <div className="flex justify-center mb-4">
            <Image
              ...
              width={320}
              height={140}
              className="object-contain w-56 sm:w-72 md:w-110 h-auto"
              priority
            />
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-xs font-semibold text-stone-400 dark:text-white/30 tracking-widest">
            اختر المستوى
          </span>
          <div className="h-px flex-1 bg-stone-200 dark:bg-white/10" />
        </div>
      ...
      <footer className="border-t border-stone-100 dark:border-white/[0.07] py-8 text-center text-xs text-stone-400 dark:text-white/25 flex flex-col items-center gap-2">
        <span>
          مرجعية موثوقة في تلقي العلم الشرعي — منهج وفق كلية الشريعة بصوتيات
          مشايخ كبار العلماء الثقات.
        </span>
        <div className="flex items-center gap-4">
          <a
            ...
            className="hover:text-stone-600 dark:hover:text-white/60 transition-colors"
          >
            الموقع الرسمي
          </a>
